...
namespace CustomLauncher
{
    ...
    public partial class ExForm : Form
    {
        ...
        int w_x = 0;
        int w_y = 0;
        private void NewMouseDown(object sender, MouseEventArgs e)
        {
            mdd = true;
            w_x = e.X;
            w_y = e.Y;
        ...
        private void NewMouseUp(object sender, MouseEventArgs e)
        {
            mdd = false;
        }
        ...
        private void SetReion()
        {
            using (GraphicsPath path =
                    ...
                    new Rectangle(Point.Empty, base.Size), 7, RoundStyle.All, true))
            {
        ...
        private void mb_MouseEnter(object sender, EventArgs e)
        {
            mb.BackColor = Color.SkyBlue;
        }

        private void mb_MouseDown(object sender, MouseEventArgs e)
        {
            mb.BackColor = Color.DeepSkyBlue;
        }

        private void mb_MouseLeave(object sender, EventArgs e)
        {
            mb.BackColor = Color.LightSkyBlue;
        }
        ...
        private void eb_MouseEnter(object sender, EventArgs e)
        {
            eb.BackColor = Color.OrangeRed;
        }

        private void eb_MouseLeave(object sender, EventArgs e)
        {
